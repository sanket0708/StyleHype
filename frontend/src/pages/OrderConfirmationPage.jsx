        ...
        {checkout && (
          <div className="space-y-8">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
              <div>
                <h2 className="text-sm uppercase tracking-widest text-gray-700">Order Id</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <h4 className="text-sm uppercase tracking-widest text-gray-700 mb-2">Payment</h4>
                <p className="text-sm text-gray-600">PayPal</p>
              </div>
              <div>
                <h4 className="text-sm uppercase tracking-widest text-gray-700 mb-2">Delivery</h4>
