          ...
          <div className="order-2 lg:order-1 w-full">
            <div className="max-w-md mx-auto px-4 sm:px-0">
              ...
              <div className="text-center mb-6 sm:mb-8">
                <h1 className="text-3xl sm:text-4xl font-bold text-amber-600 tracking-wider mb-2">STYLEHYPE</h1>
              ...
              <div className="bg-white/80 backdrop-blur-sm p-6 sm:p-8 rounded-2xl sm:rounded-3xl shadow-2xl border border-amber-100/50 relative">
                ...
                <div className="relative z-10">
                  <h2 className="text-xl sm:text-2xl font-bold text-gray-800 text-center mb-2">👋 Hey there, welcome back!</h2>
                  <p className="text-gray-600 text-center mb-6 sm:mb-8 text-sm">Sign in to continue your fashion journey</p>
                  
                  <form className="space-y-4 sm:space-y-6">
                    <div className="group">
                      <label className="block text-sm font-semibold mb-2 sm:mb-3 text-gray-700 tracking-wide">Email Address</label>
                      <input
                        type="email"
                        value={email}
                    ...
                    <div className="group">
                      <label className="block text-sm font-semibold mb-2 sm:mb-3 text-gray-700 tracking-wide">Password</label>
                      <input
                        type="password"
                        value={password}
                  ...
                  <p className="mt-4 sm:mt-6 text-center text-sm text-gray-600">
                    ...
                    <Link to="/register" className="text-amber-600 hover:text-amber-700 font-semibold transition-colors duration-300">
                      Create Account
                    </Link>
                  </p>
                </div>
